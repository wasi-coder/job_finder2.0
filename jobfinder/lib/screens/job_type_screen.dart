    ...
    return GradientBackground(
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.transparent,
          elevation: 0,
          title: Text('Option', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          centerTitle: true,
          leading: IconButton(
                ...
                children: [
                  RichText(
                    text: TextSpan(
                      ...
                      children: [
                        TextSpan(text: 'Choose ', style: TextStyle(color: Colors.white)),
                        TextSpan(text: 'Job Type', style: TextStyle(color: Color(0xFF00D9A5))),
                      ],
                    ),
                  ),
                  SizedBox(height: 12),
                  Text(
                    ...
                    style: TextStyle(fontSize: 15, color: Colors.yellow.shade100),
                  ),
                  SizedBox(height: 24),
                  Row(
                    children: [
